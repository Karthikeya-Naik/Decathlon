  ...
  return (
    <div className="bg-gray-50 min-h-screen">
      ...
      <section className="relative overflow-hidden">
        <div className="h-96 md:h-screen bg-cover bg-center relative" style={{ backgroundImage: 'url("https://source.unsplash.com/random/1920x1080/?sports,active")' }}>
      ...
      {/* Featured Products - Enhanced with unique UI */}
